<?php
    ...
    if(isset($_POST['titre']) && isset($_POST['description']) && isset($_POST['budget']) && isset($_POST['etat']))
    {
        if (!empty($_POST['titre'] && $_POST['description'] && $_POST['budget'] && $_POST['etat']))
        {
            ...
            VALUES((SELECT CONCAT(user_nom, ' ', user_prenom) AS demande_proprietaire FROM users WHERE user_email=:user_email), 
    ...
    { 
        ...
        {
            echo "<h4> La taille du fichier ne doit pas dépasser 5Mo ! </h4>";
            header("refresh:2; url=demandeNew.php");  
            exit;
        }
